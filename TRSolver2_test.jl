...
result_file = "benchmark_all_float128.csv"
...
solvers = Dict(
    ...
    # :trsolver_lbfgs_2 => (nlp; fixed_sub_rtol=true, kwargs...) -> TRSolver2.trsolver(nlp; subsolver=:lbfgs, mem=2, kwargs...),
    # :trsolver_lbfgs_50 => (nlp; fixed_sub_rtol=true, kwargs...) -> TRSolver2.trsolver(nlp; subsolver=:lbfgs, mem=50, kwargs...),
    # :trsolver_lbfgs_100 => (nlp; fixed_sub_rtol=true, kwargs...) -> TRSolver2.trsolver(nlp; subsolver=:lbfgs, mem=100, kwargs...),
    # :trsolver_lbfgs_500 => (nlp; fixed_sub_rtol=true, kwargs...) -> TRSolver2.trsolver(nlp; subsolver=:lbfgs, mem=500, kwargs...),

    # :trsolver_diom_2 => (nlp; fixed_sub_rtol=true, kwargs...) -> TRSolver2.trsolver(nlp; subsolver=:diom, mem=2, kwargs...),
    # :trsolver_diom_5 => (nlp; fixed_sub_rtol=true, kwargs...) -> TRSolver2.trsolver(nlp; subsolver=:diom, mem=5, kwargs...),
    # :trsolver_diom_50 => (nlp; fixed_sub_rtol=true, kwargs...) -> TRSolver2.trsolver(nlp; subsolver=:diom, mem=50, kwargs...),
    # :trsolver_diom_100 => (nlp; fixed_sub_rtol=true, kwargs...) -> TRSolver2.trsolver(nlp; subsolver=:diom, mem=100, kwargs...),
    # :trsolver_diom_500 => (nlp; fixed_sub_rtol=true, kwargs...) -> TRSolver2.trsolver(nlp; subsolver=:diom, mem=500, kwargs...),
)
